...
2) Your "PWD": This is the password to log-in to the database. You will have received the password via phone call, and it looks like a long random set of characters, numbers, and other symbols:
